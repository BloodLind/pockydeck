...
Collection filters show three complete populated categories between L2/R2 when space permits, with fixed All and All filters controls beside them. The last window keeps three categories visible instead of shrinking at the end. Main actions such as Clear, Edit search and Scan use larger filled buttons; category filters retain their compact style.
