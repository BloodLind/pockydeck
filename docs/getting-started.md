...
1. Download `pockydeck-0.10.6-preview.apk` from the [release page](https://github.com/BloodLind/pockydeck/releases/tag/v0.10.6).
...
```sh
adb -s SERIAL install --no-incremental -r pockydeck-0.10.6-preview.apk
```
